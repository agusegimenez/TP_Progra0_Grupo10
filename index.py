...
# Funcion que muestra el menu de opciones que puede realizar el usuario, las funciones que ejecuta retornan los datos y esta funcon, debe manejar los mensajes a mostrar